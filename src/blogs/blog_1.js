    ...
    return (
        <div className="row">
            ...
            <content className="align left">
                ...
                <p>
                    I need a daily fix of code & caffeine. This blog is written in
                    <a href="//reactjs.org/"><em>ReactJS</em></a>
                    and my exercise to pick up this latest
                    <a href="//www.destroyallsoftware.com/talks/wat"><em> JS beauty </em></a>
                    is what partially led to me start up this blog. I plan to take up
                    other tech topics soon. Probably once when I've made my peace with
                    ReactJS.
                </p>
                <p>
                    My endeavors to
                    <a href="//cleartax.in/s/income-tax-allowances-and-deductions">
                        <em> save on my income tax </em>
                    </a>
                    ...
                    recording them. Probably, I'll start researching better.
                    <a href="//www.starwars.com/may-the-4th">
